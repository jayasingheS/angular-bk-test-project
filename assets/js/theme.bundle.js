...
var bootstrap_esm = __webpack_require__(3);
...
var duDatepicker = __webpack_require__(4);
...
var pies = __webpack_require__(149);
...
jQuery(document).ready(function ($) {
    ...
    $('input[type=radio][name=invoiceTheme]').change(function () {
        ...
        $('head').append('<style type="text/css" data-custom-theme>*{--accent-color: ' + color + ';}</style>');
    });
    ...
    $('input[name=invoiceThemeCustom]').change(function () {
        ...
        $('head').append('<style type="text/css" data-custom-theme>*{--accent-color: ' + this.value + ';}</style>');
    });
    ...
    var rejectList = ["preview-editor-tab", "save-editor-tab", "print-editor-tab"];
...
var tagList = ['Your full name', 'Your first name', 'Your business name', 'Client business name', 'Client contact name', 'Invoice number', 'Due date', 'Month', 'Month and year', 'Invoice amount'];
...
var myToolTip = {
    ...
    custom: function (tooltipModel) {
        ...
        if (!tooltipEl) {
            ...
            tooltipEl.innerHTML = '<div class="caret"></div><div class="d-flex legend-container"></div>';
